...
class Registered_Doctor(models.Model):
    ...
    ddob = models.DateField(max_length=150)
    dmobile = models.CharField(max_length=100)
    ...
    # dimage = models.ImageField(max_length=500)
    dabout = models.CharField(max_length=500)
